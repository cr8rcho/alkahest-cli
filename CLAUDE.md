...
> `buildServer(remote?)` has two consumers: local stdio (`alkahest mcp`, 47 tools) and the
> hosted remote connector (41 tools — `remote` mode skips scan/publish/set_summary/set_prd/
